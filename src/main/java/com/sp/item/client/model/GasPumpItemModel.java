...
public class GasPumpItemModel extends GeoModel<GasPumpItem> {
    ...
    public ResourceLocation getModelResource(GasPumpItem animatable) {
        return ResourceLocation.fromNamespaceAndPath(SPBRevamped.MOD_ID, "geo/blocks/staircase.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(GasPumpItem animatable) {
        return ResourceLocation.fromNamespaceAndPath(SPBRevamped.MOD_ID, "textures/block/staircase.png");
    }

    @Override
    public ResourceLocation getAnimationResource(GasPumpItem animatable) {
        return ResourceLocation.fromNamespaceAndPath(SPBRevamped.MOD_ID, "animations/staircase.animation.json");
    }
}