...
public class PoolroomsSunsetAmbienceSoundInstance extends AbstractTickableSoundInstance {
    private final Player player;

    public PoolroomsSunsetAmbienceSoundInstance(Player player) {
        super(ModSounds.POOLROOMS_AMBIENCE_SUNSET, SoundSource.AMBIENT, SoundInstance.createUnseededRandom());
        this.player = player;
        this.looping = true;
        this.delay = 0;
        this.volume = 0.5F;
